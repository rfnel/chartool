...
@Component
public class RadarChartScriptGenerator implements ChartScriptGenerator {
    ...
    private static final String CHART_SCRIPT_TEMPLATE = "js_templates/radar_charts/radar_chart.template";
    private static final String CHART_DATASET_TEMPLATE = "js_templates/radar_charts/radar_chart_dataset.template";
