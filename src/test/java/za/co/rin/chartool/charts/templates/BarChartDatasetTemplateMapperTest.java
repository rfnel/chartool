...
public class BarChartDatasetTemplateMapperTest {

    private BarChartDatasetTemplateMapper templateMapper;
    ...
    public void setUp() {
        ...
        this.templateMapper = new BarChartDatasetTemplateMapper(this.chartColorManagerMock);
    }
    ...
    public void testMapDatasetToTemplate() throws Exception {
        ...
        String mappedDataset = templateMapper.mapDatasetToTemplate(new ScriptTemplate(TEMPLATE_TEXT), "test", dataItems, 1);
